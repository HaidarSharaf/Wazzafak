...
>
    ...
    @if (session()->has('error'))
        <div
            ...
            x-show="show"
            x-transition.opacity.duration.500ms
            class="fixed flex gap-2 items-center z-50 right-5 bottom-4 md:p-4 p-2 bg-red-200 text-red-800 shadow-lg rounded-lg font-bold sm:text-base text-sm"
            x-cloak
        >
            {{ $message }}
        </div>
