<div class="w-full">
    <section class="flex flex-col md:flex-row items-center justify-between px-10 py-20 bg-black/20 rounded-lg">
        ...
        <div class="md:w-1/2 mb-10 md:mb-0">
            ...
            <a
                href="{{ route('register') }}"
                wire:navigate
                class="bg-white text-[#142b57] font-bold py-3 px-6 rounded-xl text-lg hover:bg-lime-300 hover:text-blue-800 transition"
            >
                Get Started
            </a>
        </div>
        ...
        <div class="md:w-1/2">
            <img src="{{ asset('images/home-photo.png') }}" class="w-full max-w-md mx-auto">
        </div>
    ...
    <section class="bg-gradient-to-br from-blue-50 to-indigo-100 py-16 px-10 mt-10 rounded-lg">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mt-12">
                ...
                <p class="text-sm font-semibold text-[#19468f] mt-3">No credit card required • Free for developers and recruiters</p>
            </div>
        </div>
    </section>
